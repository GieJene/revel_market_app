...
export default class Shop extends React.Component {
    ...
    render() {
        ...
        return (                
            <Content style={{ backgroundColor: '#534335', }}>
                <Header style={{ backgroundColor: '#3D3127', }}>
                    <ImageBackground 
                        resizeMode='cover' 
                ...
                <View style={{ padding: 12, }}>
                    <View style={[{ height: 48, backgroundColor: '#FFF', flexDirection: 'row', borderRadius: 25, elevation: 3, }]}>
                        <TextInput style={[ styles.text_font, { flex: 1, paddingLeft: 18, }]}
                            placeholder="What are you looking for ?" 
                            placeholderTextColor="#3D3127"
                            underlineColorAndroid="transparent"
                            onChangeText={(keyword) => { this.setState({ keyword }) }}
                            value={this.state.keyword} 
                        />
                        <TouchableOpacity style={{ width: 50, height: 60, }} onPress={() => { this._fetchData() }}>
                            <Icon name="magnify" size={28} style={{ color: '#3D3127', marginTop: 10, }} />
                        </TouchableOpacity>
                    </View>
                </View>
                <ScrollView>
